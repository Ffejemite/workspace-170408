...
cprequire_test(["inline:com-chilipeppr-workspace-test_170408"], function(ws) {
    ...
    $('title').html("test_170408 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-test_170408", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-test_170408", // Make the id the same as the cpdefine id
        name: "Workspace / test_170408", // The descriptive name of your widget.
        desc: `Jeff's ChiliPeppr Workspace test_170408.`,
